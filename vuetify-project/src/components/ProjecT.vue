          ...
          <v-row>
            <v-col cols="12">
              ...
              >
                ...
                <template #title>
                  <h2 class="text-h5 font-weight-bold">Github</h2>
                </template>

                <template #subtitle>
                  <div class="text-subtitle-1">
                    View this page on my github <br />
                    <v-kbd>
                      <a
            ...
            >
              <v-card>
                ...
                <v-card-actions left>
                  ...
                  <v-btn color="primary" @click="registerDialog = false"
                    >Register</v-btn
                  >
                </v-card-actions>
              </v-card>
